...
<p><?= $fetch_profile['name']; ?></p>
        ...
        <div class="box">
            <?php 
            $select_active_product = $conn->prepare("SELECT * FROM `product` WHERE seller_id = ? AND status = ? ");
        ...
        <div class="box">
            <?php 
            $select_deactive_product = $conn->prepare("SELECT * FROM `product` WHERE seller_id = ? AND status = ? ");
