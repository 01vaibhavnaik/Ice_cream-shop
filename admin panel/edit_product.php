<?php
    ...
    if(isset($_POST['update'])){
        ...
        $update_product = $conn->prepare("UPDATE `product` SET name = ?, price = ?, product_detail = ?, stock = ?, status = ? WHERE id = ?");
    ...
    if(isset($_POST['delete_image'])){
        ...
        $fetch_delete_image = $delete_imagep->fetch(PDO::FETCH_ASSOC);

        if($fetch_delete_image['image'] != ''){
            unlink('../uploaded_file/'.$fetch_delete_image['image']);
        }
        $unset_image = $conn->prepare("UPDATE `product` SET image = ? WHERE id = ?");
        ...
        <div class="form-container">
            <form action="" method="post" enctype="multipart/form-data" class="register">
                ...
                <div class="input-field">
                    ...
                    <input type="nunber" name="price" value="<?= $fetch_product['price'];?>" class="box">
                </div>
                <div class="input-field">
                ...
                <div class="input-field">
                    ...
                    <input type="nunber" name="stock" value="<?= $fetch_product['stock']; ?>" class="box" min="0" max="9999999999" maxlength="10">
                </div>
                <div class="input-field">
                    ...
                    <?php if($fetch_product['image'] != ''){?>
                        ...
                        <div class="flex-btn">
                            ...
                            <a href="view_product.php" class="btn" style="width: 30%; height: 3rem; margin-top: .7rem">go back</a>
                        </div>
                        <?php } ?>
                </div>
                <div class="flex-btn">
